		...
		<div class="container-fluid">
			...
			<form id="staffEditProfile" action="submitedit.php" method="POST" role="form" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="name" value="<?php echo $staff->nama;?>"  name="name">
				</div>

				<div class="form-group">
					<label for="ktp">ID Card Number</label>
					<input type="text" class="form-control" id="ktp" value="<?php echo $staff->ktp;?>" readonly name="ktp">
				</div>

				<div class="form-group">
					<label for="address">Address</label>
					<p id="warningAddress" class="warningTxt"></p>
					<textarea name="address" id="address" class="form-control" rows="3"><?php echo $staff->alamat;?></textarea>
				</div>

				<div class="form-group">
					<label for="gender">Gender</label>
					<input type="text" class="form-control" id="gender" value="<?php echo $staff->gender;?>" readonly name="gender">
				</div>

				<div class="form-group">
					<label for="tglLahir">Birth Date</label>
					<input type="text" name="tglLahir" value="<?php echo $staff->tglLahir->format('d/m/y'); ?>" readonly id="tglLahir" class="form-control">
				</div>

				<div class="form-group">
					<label for="HP">Phone Number</label>
					<p id="warningHP" class="warningTxt"></p>
					<input type="text" class="form-control" id="HP" value="<?php echo $staff->hp; ?>" placeholder="Phone Number" name="hp">
				</div>

				<div class="form-group">
					<label for="tglGabung">Join Date</label>
					<input type="text" name="tglGabung" id="tglGabung" value="<?php echo $staff->tglGabung->format('d/m/y'); ?>" readonly class="form-control">
				</div>

				<div class="form-group">
					<label for="email">Email Address</label>
					<p id="warningEmail" class="warningTxt"></p>
					<input type="text" class="form-control" id="email" value="<?php echo $staff->email; ?>" readonly name="email">
				</div>

				<div class="form-group">
					<label for="password">Password</label>
					<p id="warningPassword" class="warningTxt"></p>
					<input type="password" class="form-control" id="password" value="<?php echo $staff->password; ?>" name="password">
				</div>
